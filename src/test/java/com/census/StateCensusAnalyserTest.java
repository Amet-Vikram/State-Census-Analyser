...
public class StateCensusAnalyserTest {
    public static final String STATE_CODE_CSV_PATH = "src/main/resources/StateCode.csv";
    public static final String STATE_CENSUS_CSV_PATH = "src/main/resources/StateCensusData.csv";
